...
Rectangle {
    ...
    property RemoteCommunicationHandler pageRemoteHandler: remoteCommunicationHandler
    ...
    Image {
        ...
        Image {
            ...
            Loader {
                ...
                source: "CommunicationStateLocalComponent.qml"
            }
                ...
                Item {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            // 加载现地通信组件
                            loader.source = "CommunicationStateLocalComponent.qml"
                        }
                    }
                }
                ...
                Item {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            // 加载远程通信组件
                            loader.source = "CommunicationStateRemoteComponent.qml"
                        }
                    }
                }
            }
