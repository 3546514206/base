...
Item {
    ...
    property RemoteCommunicationHandler remoteHandler: pageRemoteHandler

    property string recevieStr: remoteHandler.newReceivedByteData
    property string sendStr: remoteHandler.newSendByteData
