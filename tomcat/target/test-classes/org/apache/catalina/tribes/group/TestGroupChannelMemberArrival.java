...
public class TestGroupChannelMemberArrival {
    ...
    public void setUp() throws Exception {
        for (int i = 0; i < channels.length; i++) {
            ...
            channels[i].getMembershipService().setPayload( ("Channel-" + (i + 1)).getBytes(StandardCharsets.US_ASCII));
    ...
    public static class TestMbrListener
        ...
        private void report(String event, Member member, int count) {
            ...
            try {
                message.append(new String(member.getPayload(), StandardCharsets.US_ASCII));
            } catch (Exception x) {
