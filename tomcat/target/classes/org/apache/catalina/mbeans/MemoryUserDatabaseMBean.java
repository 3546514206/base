...
public class MemoryUserDatabaseMBean extends BaseModelMBean {
    ...
    public String createGroup(String groupname, String description) {
        ...
        try {
            ...
            IllegalArgumentException iae = new IllegalArgumentException
                ("Exception creating group [" + groupname + "] MBean", e);
            throw iae;
        }
    ...
    public String createRole(String rolename, String description) {
        ...
        try {
            ...
            IllegalArgumentException iae = new IllegalArgumentException
                ("Exception creating role [" + rolename + "] MBean", e);
            throw iae;
        }
    ...
    public String createUser(String username, String password,
        ...
        try {
            ...
            IllegalArgumentException iae = new IllegalArgumentException
                ("Exception creating user [" + username + "] MBean", e);
            throw iae;
        }
    ...
    public String findGroup(String groupname) {
        ...
        try {
            ...
            IllegalArgumentException iae = new IllegalArgumentException
                ("Cannot create object name for group [" + groupname + "]", e);
            throw iae;
        }
    ...
    public String findRole(String rolename) {
        ...
        try {
            ...
            IllegalArgumentException iae = new IllegalArgumentException
                ("Cannot create object name for role [" + rolename + "]", e);
            throw iae;
        }
    ...
    public String findUser(String username) {
        ...
        try {
            ...
            IllegalArgumentException iae = new IllegalArgumentException
                ("Cannot create object name for user [" + username + "]", e);
            throw iae;
        }
    ...
    public void removeGroup(String groupname) {
        ...
        try {
            ...
            IllegalArgumentException iae = new IllegalArgumentException
                ("Exception destroying group [" + groupname + "] MBean", e);
            throw iae;
        }
    ...
    public void removeRole(String rolename) {
        ...
        try {
            ...
            IllegalArgumentException iae = new IllegalArgumentException
                ("Exception destroying role [" + rolename + "] MBean", e);
            throw iae;
        }
    ...
    public void removeUser(String username) {
        ...
        try {
            ...
            IllegalArgumentException iae = new IllegalArgumentException
                ("Exception destroying user [" + username + "] MBean", e);
            throw iae;
        }
